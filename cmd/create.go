...
func init() {
	...
	appCmd.Flags().Bool("addon-database", false, "setup database add-on (database instance must already exist -- run `apppack create database` first; use --addon-database-name to select a specific instance when multiple exist)")
	...
	pipelineCmd.Flags().Bool("addon-database", false, "setup database add-on (database instance must already exist -- run `apppack create database` first; use --addon-database-name to select a specific instance when multiple exist)")
	pipelineCmd.Flags().String("addon-database-name", "", "database instance name to install add-on (implies --addon-database)")
	pipelineCmd.Flags().Bool("addon-redis", false, "setup Redis add-on (Redis instance must already exist -- run `apppack create redis` first; use --addon-redis-name to select a specific instance when multiple exist)")
	pipelineCmd.Flags().String("addon-redis-name", "", "Redis instance name to install add-on (implies --addon-redis)")
